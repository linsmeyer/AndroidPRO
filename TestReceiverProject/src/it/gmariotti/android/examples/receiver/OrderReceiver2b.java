...
public class OrderReceiver2b extends BroadcastReceiver {

	private static final String TAG = "OrderReceiver2b";

	public OrderReceiver2b() {
	}
	...
	public void onReceive(Context context, Intent intent) {
		...
		// an Intent broadcast.
		Log.i(TAG, "new Intent Received 2b");
		...
		if (resultExtras != null) {
			...
			resultExtras.putString("data2b", context.getString(R.string.text_data2));
		}
