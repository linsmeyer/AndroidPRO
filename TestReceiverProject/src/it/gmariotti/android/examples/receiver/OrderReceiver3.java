...
public class OrderReceiver3 extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		// an Intent broadcast.
		Log.i(TAG, "new Intent Received 3");
		...
		setResultData(getResultData() + context.getString(R.string.text_data3));
		...
		if (resultExtras != null) {
			...
			resultExtras.putString("data3", context.getString(R.string.text_data3));
		}
